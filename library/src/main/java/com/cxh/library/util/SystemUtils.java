...
public class SystemUtils {
	...
	public static boolean isCanUseSim() {
		...
		TelephonyManager mgr = (TelephonyManager) App.getContext().getSystemService(Context.TELEPHONY_SERVICE);
	...
	public static String getMacAddress() {
		...
		WifiManager wm = (WifiManager) App.getContext().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
	...
	public static long getUsedMemory(String packageName) {
		...
		if (TextUtils.isEmpty(packageName)) {
			packageName = App.getContext().getPackageName();
		}
		long size = 0;
		ActivityManager activityManager = (ActivityManager) App.getContext().getSystemService(Context.ACTIVITY_SERVICE);
