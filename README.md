...
- [Material Theme  UI](https://plugins.jetbrains.com/plugin/8006?pr=) AS皮肤
...
- [androidstudio-plugins](https://github.com/dreamlivemeng/androidstudio-plugins) 优秀插件汇总
- [ECTranslation](https://github.com/Skykai521/ECTranslation) 翻译插件


### 完整项目
- [CoCoin](https://github.com/Nightonke/CoCoin) 一款多视图记账APP
- [Meizhi](https://github.com/drakeet/Meizhi)                            每天自动更新一张精选妹纸图、一个小视频、一系列精选程序猿干货（周末不更新）
- [SimplifyReader](https://github.com/SkillCollege/SimplifyReader) 简阅
- [Douya](https://github.com/DreaminginCodeZH/Douya) 豆瓣客户端
- [SeeWeather](https://github.com/xcc3641/SeeWeather) 就看天气
- [WeiBo](https://github.com/wenmingvs/WeiBo) 第三方新浪微博客户端
- [SprintNBA](https://github.com/smuyyh/SprintNBA)                          完整的NBA第三方Android客户端
- [Ghost](https://github.com/GeekGhost/Ghost) 一款纯粹的在线视频App
- [GeekNews](https://github.com/codeestX/GeekNews) 极客日报
- [MeizhiGank](https://github.com/chkfung/MeizhiGank) 看妹纸
- [MaterialHome](https://github.com/hymanme/MaterialHome) 图书展示类app
- [PlayTogether](https://github.com/Chenantao/PlayTogether)                 一款以兴趣为驱动的陌生人社交app
- [yyquan](https://github.com/jiangzehui/yyquan) 基于Xmpp协议的即时通讯社交软件(客户端+服务端)


### 系统架构
- [MasteringAndroidDataBinding](https://github.com/LyndonChin/MasteringAndroidDataBinding)
- [Fragmentation](https://github.com/YoKeyword/Fragmentation)
- [Basic](https://github.com/meikoz/Basic) 封装了retrofit + okhttp + logger 
- [MVVMLight](https://github.com/Kelin-Hong/MVVMLight)
- [LoadingAndRetryManager](https://github.com/hongyangAndroid/LoadingAndRetryManager) 设置加载（loading）、重试(retry)和无数据（empty）页面
- [RapidLibs](https://github.com/MarnonDev/RapidLibs) 常用功能的封装
...
- [PolygonImageView](https://github.com/AlbertGrobas/PolygonImageView)      多边形图片
- [GIF images](https://github.com/felipecsl/GifImageView)
- [Fresco](https://github.com/scp504677840/Fresco) FrescoDemo
- [GestureViews](https://github.com/alexvasilkov/GestureViews)
  [PinchImageView](https://github.com/boycy815/PinchImageView) 图片查看器
- [Luban](https://github.com/Curzibn/Luban) 图片压缩
- [SlideImageView](https://github.com/DevLight-Mobile-Agency/SlideImageView) 
  [KenBurnsView](https://github.com/flavioarfaria/KenBurnsView) 幻灯片
- [BlurredView](https://github.com/wl9739/BlurredView) 背景虚化
- [PloyFun](https://github.com/hugeterry/PloyFun) 低平面风
- [BGAPhotoPicker-Android](https://github.com/bingoogolapple/BGAPhotoPicker-Android) Android 图片选择、预览、九宫格图片控件、拖拽排序九宫格图片控件
- [NineGridView](https://github.com/jeasonlzy/NineGridView)                 图片的九宫格控件
- [RoundImageView](https://github.com/LineChen/RoundImageView)              圆形图片和可控位置圆角图片
- [BigImageViewer](https://github.com/Piasy/BigImageViewer) 显示大图


#### 图片处理
- [StickerCamera](https://github.com/Skykai521/StickerCamera)               这是一款集成了相机,图片裁剪,给图片贴贴图打标签的APP
...
- [Instagram_Filter](https://github.com/yulu/Instagram_Filter)
...
- [LabelView](https://github.com/corerzhang/LabelView)
- [Android-PictureTagView](https://github.com/saiwu-bigkoo/Android-PictureTagView)
- [BadgedImageview](https://github.com/yesidlazaro/BadgedImageview)
...
- [IPicker](https://github.com/liuguangqiang/IPicker)


### 第三方库
- [butterknife](https://github.com/JakeWharton/butterknife) 依赖注入
- [zxing](https://github.com/zxing/zxing) 二维码扫描
- [leakcanary](https://github.com/square/leakcanary) 内存泄漏检测
- [fastjson](https://github.com/alibaba/fastjson) json和对象转换
- [logger](https://github.com/orhanobut/logger) 
  [KLog](https://github.com/ZhaoKaiQiang/KLog) LogCat工具
- [Calligraphy](https://github.com/chrisjenx/Calligraphy) 
  [FontsManager](https://github.com/GcsSloop/FontsManager) 字体替换
- [DanmakuFlameMaster](https://github.com/Bilibili/DanmakuFlameMaster)      开源弹幕引擎·烈焰弹幕使
- [richeditor-android](https://github.com/wasabeef/richeditor-android)      富文本编辑器
- [packer-ng-plugin](https://github.com/mcxiaoke/packer-ng-plugin) 下一代Android打包工具
- [FFmpegMediaMetadataRetriever](https://github.com/wseemann/FFmpegMediaMetadataRetriever) 网络视频截图
- [ASimpleCache](https://github.com/yangfuhai/ASimpleCache)  轻量级的开源缓存框架


### 实用功能
- [SwipeBackLayout](https://github.com/ikew0ng/SwipeBackLayout) 滑动关闭
- [colorpreference](https://github.com/kizitonwose/colorpreference)         颜色选择器
- [Android-FilePicker](https://github.com/DroidNinja/Android-FilePicker)    文挡和图片选择
- [AutoInstaller](https://github.com/a-voyager/AutoInstaller) 静默安装
- [UpdateDemo](https://github.com/hugeterry/UpdateDemo) 检查更新
- [android-vertical-slide-view](https://github.com/xmuSistone/android-vertical-slide-view)    
  [VerticalSlideView](https://github.com/jeasonlzy/VerticalSlideView) 仿照淘宝商品详情页
- [StepView](https://github.com/baoyachi/StepView) 物流跟踪
- [MoveMapLocation](https://github.com/scp504677840/MoveMapLocation)        移动地图选址
- [BGAQRCode-Android](https://github.com/bingoogolapple/BGAQRCode-Android)
  [android-zxingLibrary](https://github.com/yipianfengye/android-zxingLibrary)扫描二维码
- [ColorTrackView](https://github.com/hongyangAndroid/ColorTrackView)       逐渐变色
- [JsBridge](https://github.com/lzyzsd/JsBridge) java and javascript通信


### Google Demo
- [android-UniversalMusicPlayer](https://github.com/googlesamples/android-UniversalMusicPlayer)
- [android-support-23.2-sample](android-support-23.2-sample) 
- [CoordinatorLayoutDemos](https://github.com/sungerk/CoordinatorLayoutDemos)


#### Material Design
- [Android-ObservableScrollView](https://github.com/ksoichiro/Android-ObservableScrollView)
- [Awesome-MaterialDesign](https://github.com/lightSky/Awesome-MaterialDesign#google-samples)
- [material](https://github.com/rey5137/material)
- [Awesome-MaterialDesign](https://github.com/lightSky/Awesome-MaterialDesign)
- [SupportLibraryDemo](https://github.com/crazy1235/SupportLibraryDemo)
- [DesignSupportLibrarySample](https://github.com/WuXiaolong/DesignSupportLibrarySample)
...
- [skin-sprite](https://github.com/geminiwen/skin-sprite)
- [NightModel](https://github.com/achenglike/NightModel)
- [StyleDemo](https://github.com/zhuguohui/StyleDemo)
- [ChangeMode](https://github.com/zhangke3016/ChangeMode)
...
- [StylishMusicPlayer](https://github.com/ryanhoo/StylishMusicPlayer)       音乐播放器
...
- [UserGuideView](https://github.com/yilylong/UserGuideView)
...
### 下拉刷新
- [BeautifulRefreshLayout](https://github.com/android-cjj/BeautifulRefreshLayout) 集合
- [Android-PullToRefresh](https://github.com/chrisbanes/Android-PullToRefresh)
- [android-Ultra-Pull-To-Refresh](https://github.com/liaohuqiu/android-Ultra-Pull-To-Refresh)
- [SRecyclerView](https://github.com/Huyamin150/SRecyclerView) 水果生鲜
- [Phoenix](https://github.com/Yalantis/Phoenix) 太阳升起
- [Taurus](https://github.com/Yalantis/Taurus) 飞机起飞
- [pull-to-make-soup](https://github.com/Yalantis/pull-to-make-soup)        厨房煮菜
- [FunGameRefresh](https://github.com/Hitomis/FunGameRefresh)               黑白掌上游戏机
- [WaveSwipeRefreshLayout](https://github.com/recruit-lifestyle/WaveSwipeRefreshLayout) 水滴
- [CircleRefreshLayout](https://github.com/tuesda/CircleRefreshLayout)
- [Android-MaterialRefreshLayout](https://github.com/android-cjj/Android-MaterialRefreshLayout) 太阳笑脸
- [ChromeLikeSwipeLayout](https://github.com/ashqal/ChromeLikeSwipeLayout)   淘宝样式
- [SmartisanPull](https://github.com/hougr/SmartisanPull) 锤子下拉
- [SmileyLoadingView](https://github.com/andyxialm/SmileyLoadingView)       支付宝笑脸
- [PullToRefresh](https://github.com/lynnchurch/PullToRefresh) qq下拉
- [SwipyRefreshLayout](https://github.com/OrangeGangsters/SwipyRefreshLayout)  知乎下拉
- [JellyRefreshLayout](https://github.com/imallan/JellyRefreshLayout) 
- [FlyRefresh](https://github.com/race604/FlyRefresh) 纸飞机
- [BeautifulRefreshLayout](https://github.com/android-cjj/BeautifulRefreshLayout/tree/BeautifulRefreshForFood) 肯德基
- [TwinklingRefreshLayout](https://github.com/lcodecorex/TwinklingRefreshLayout)
- [AJWaveRefreshForAndroid](https://github.com/alienjun/AJWaveRefreshForAndroid) 玻璃瓶注水
- [pullToRefresh](https://github.com/diamondlin2016/pullToRefresh) 购物袋
- [SmileRefresh](https://github.com/songixan/SmileRefresh) 微笑下拉刷新
- [SpringView](https://github.com/liaoinstan/SpringView) 齿轮
- [RecyclerRefresh](https://github.com/leoleohan/RecyclerRefresh) 自动加载

#### RecyclerView
- [XRecyclerView](https://github.com/jianghejie/XRecyclerView) 
- [LRecyclerView](https://github.com/jdsjlzx/LRecyclerView) 带侧滑删除

### Menu导航
- [SlidingMenu](https://github.com/jfeinstein10/SlidingMenu)
- [FlowingDrawer](https://github.com/mxn21/FlowingDrawer)
- [GuillotineMenu-Android](https://github.com/Yalantis/GuillotineMenu-Android) 断头台
...
- [SpinMenu](https://github.com/Hitomis/SpinMenu)                           轮盘样式的Fragment选择菜单
- [NavigationTabBar](https://github.com/DevLight-Mobile-Agency/NavigationTabBar)
- [Android-CircleMenu](https://github.com/hongyangAndroid/Android-CircleMenu) 建行圆形菜单
...
- [WechatLikeBottomTabUI](https://github.com/wuyexiong/WechatLikeBottomTabUI)
  [AlphaIndicatorView](https://github.com/jeasonlzy/AlphaIndicatorView)   仿微信底部tab标签
...
- [ViewPagerIndicator](https://github.com/ImmortalZ/ViewPagerIndicator) 仿猫眼顶部切换栏
- [VerticalTabLayout](https://github.com/qstumn/VerticalTabLayout) 垂直纵向的TabLayout
...
- [SunBaby](https://github.com/Hitomis/SunBaby) 萌萌哒太阳宝宝
- [BounceLoadingView](https://github.com/niniloveyou/BounceLoadingView)     模仿饿了么加载效果
- [HouseLoading](https://github.com/BaymaxTong/HouseLoading)、
- [AnimatedCircleLoadingView](https://github.com/jlmd/AnimatedCircleLoadingView) 
- [LauncherView](https://github.com/diamondlin2016/LauncherView) 


### 动画
- [AndroidViewAnimations](https://github.com/daimajia/AndroidViewAnimations) [wava](https://github.com/hujiaweibujidao/wava)  Android View Animation
- [Depth-LIB-Android-](https://github.com/danielzeller/Depth-LIB-Android-)
  树林篝火、夕阳波浪
- [android-flip](https://github.com/openaphid/android-flip) 电子书翻页
- [TextSurface](https://github.com/elevenetc/TextSurface)
- [LoopRotarySwitch](https://github.com/dalong982242260/LoopRotarySwitch)
  3d旋转切换view
- [BezierMaker](https://github.com/venshine/BezierMaker) 贝塞尔曲线
- [yava](https://github.com/hujiaweibujidao/yava) Interpolator
- [Sending-Animation-Example](https://github.com/Jaouan/Sending-Animation-Example)
- [android-ui](https://github.com/markushi/android-ui)                      按钮动画、水波纹点击
...
- [WaveCompat](https://github.com/wangjiegulu/WaveCompat)
- [ActSwitchAnimTool](https://github.com/Yellow5A5/ActSwitchAnimTool)
- [RippleEffect](https://github.com/traex/RippleEffect) 水波纹
...
### 自定义控件
- [CouponView](https://github.com/dongjunkun/CouponView) 优惠券
- [HeartLayout](https://github.com/tyrantgit/HeartLayout)
[QQBubbleView](https://github.com/Yasic/QQBubbleView) 直播点赞
- [CreditCardView](https://github.com/vinaygaba/CreditCardView)
[CreditCardView](https://github.com/sharish/CreditCardView) 创建信用卡
- [PaperShredder](https://github.com/ldoublem/PaperShredder) 碎纸机
- [GiftCard](https://github.com/ldoublem/GiftCard) 礼物卡
- [FlightSeat](https://github.com/ldoublem/FlightSeat) 机票选座
- [StereoView](https://github.com/ImmortalZ/StereoView) 3D立体无限旋转容器
- [WeChatPswKeyboard](https://github.com/zuiwuyuan/WeChatPswKeyboard)
  [NumberKeyboard](https://github.com/wangshaolei/NumberKeyboard) 数字键盘
- [Pulsator4Droid](https://github.com/booncol/Pulsator4Droid) 声波
- [ScratchView](https://github.com/sharish/ScratchView)                 [android_scratchoff](https://github.com/jackpocket/android_scratchoff)      刮刮奖
- [emojicon](https://github.com/rockerhieu/emojicon)            [Emoji](https://github.com/vanniktech/Emoji) 表情
- [AndroidCustomView](https://github.com/AllenCoder/AndroidCustomView)      投票排名对比图
- [SpinnerLoader](https://github.com/fenjuly/SpinnerLoader) 黏性转圈
- [AndroidPdfViewer](https://github.com/barteksc/AndroidPdfViewer) PDF
- [BadgeRadioButton](https://github.com/hcs-xph/BadgeRadioButton)           仿QQ底部Tab切换带数字提示的RadioButton
- [DropDownMenu](https://github.com/dongjunkun/DropDownMenu)                一个实用的多条件筛选菜单
- [TagSelectorView](https://github.com/Rock610/TagSelectorView) 标签选择器
- [WheelView-Android](https://github.com/lantouzi/WheelView-Android) 刻度
- [CrazyShadow](https://github.com/Hitomis/CrazyShadow) 添加阴影效果
- [AZBarrage](https://github.com/Xieyupeng520/AZBarrage) 弹幕效果
- [RadarScan](https://github.com/ImmortalZ/RadarScan) 模仿QQ附近的人
- [ENViews](https://github.com/codeestX/ENViews) 一个华丽丽的动效控件库


### View 
- [nice-spinner](https://github.com/arcadefire/nice-spinner)  Spinner
- [ProgressWebView](https://github.com/dunwen/ProgressWebView)    带进度的webview
...
### Layout
- [ProgressLayout](https://github.com/iammert/ProgressLayout)               带进度条的Layout
- [MarqueeLayoutLibrary](https://github.com/oubowu/MarqueeLayoutLibrary)
一个支持四个方向循环滚动的Layout
- [CircleLayout](https://github.com/francoiscampbell/CircleLayout) 
- [AnimatedRandomLayout](https://github.com/Windsander/AnimatedRandomLayout) 在屏幕上随机生成可供操作的子控件控件
- [android-percent-support-extend](https://github.com/hongyangAndroid/android-percent-support-extend) Google百分比布局库的扩展
- [AndroidAutoLayout](https://github.com/hongyangAndroid/AndroidAutoLayout) 
[Android-ScaleLayout](https://github.com/gavinliu/Android-ScaleLayout)
Android屏幕适配方案
- [DiagonalLayout](https://github.com/florent37/DiagonalLayout) 斜角Layout
...
- [MarqueeView](https://github.com/sfsheng0322/MarqueeView) 
  [noticeview](https://github.com/czy1121/noticeview) 垂直跑马灯
- [UnderLineLinkTextView](https://github.com/wangshaolei/UnderLineLinkTextView) 添加下划线
- [ticker](https://github.com/robinhood/ticker) 
[ScrollNumber](https://github.com/a-voyager/ScrollNumber) 数字滚动
- [Badge](https://github.com/nekocode/Badge) 
- [EmphasisTextView](https://github.com/athkalia/EmphasisTextView)          文字高亮着色
- [BubbleTextView](https://github.com/dupengtao/BubbleTextView) 气泡提示
- [CountdownView](https://github.com/iwgang/CountdownView)
  [EasyCountDownTextureView](https://github.com/CaMnter/EasyCountDownTextureView) 倒计时


### Button
- [ThumbUp](https://github.com/ldoublem/ThumbUp) 
  [SmallBang](https://github.com/hanks-zyh/SmallBang)
  [ShineButton](https://github.com/ChadCSong/ShineButton) 点赞
...
[android-process-button](https://github.com/dmytrodanylyk/android-process-button) 带有进度条按钮
...
- [SwitchButton](https://github.com/BaymaxTong/SwitchButton)                日间夜间模式切换按钮
- [FaceOffToggleButton](https://github.com/Nightonke/FaceOffToggleButton)
- [ToggleButton](https://github.com/zcweng/ToggleButton)
- [badgebutton](https://github.com/czy1121/badgebutton) 带有徽标(数字，小红点)的按钮
- [roundbutton](https://github.com/czy1121/roundbutton) 可设置圆角背景边框的的按钮


### EditText
- [MaterialEditText](https://github.com/rengwuxian/MaterialEditText)
- [showhidepasswordedittext](https://github.com/scottyab/showhidepasswordedittext) 密码输入框
- [HintAnim-EditText](https://github.com/cctanfujun/HintAnim-EditText)      热点展示
- [AutoFillEmailEditText](https://github.com/wangshaolei/AutoFillEmailEditText) 自动补充email
- [BankCardFormat](https://github.com/smuyyh/BankCardFormat)                自动格式化银行卡号
- [TyperEditText](https://github.com/andyxialm/TyperEditText) 打字机效果
...
- [ElasticDownload](https://github.com/Tibolte/ElasticDownload)  
  ...
  晾衣杆下载进度条
- [ArrowDownloadButton](https://github.com/fenjuly/ArrowDownloadButton)     圆框波浪下载进度条
...
- [velocimeter-view](https://github.com/glomadrian/velocimeter-view)        流量加速器
...
- [CircleDisplay](https://github.com/PhilJay/CircleDisplay) 
- [CBprogressBar](https://github.com/yilylong/CBprogressBar)                一个简单的自定义进度条
- [PercentageCircle](https://github.com/nugongshou110/PercentageCircle)
- [SuperCircleSample](https://github.com/HayDar-Android/SuperCircleSample)
...
- [spots-dialog](https://github.com/d-max/spots-dialog)                     win10等待效果对话框
- [Android-SVProgressHUD](https://github.com/saiwu-bigkoo/Android-SVProgressHUD) 精仿iOS的提示库 SVProgressHUD
- [BottomDialogs](https://github.com/javiersantos/BottomDialogs)
- [DropDownWarning](https://github.com/Brudigem/DropDownWarning)            顶部弹出dialog
- [ColorDialog](https://github.com/andyxialm/ColorDialog)
- [ToastBar](https://github.com/SwiftyWang/ToastBar) 一个ToastBar, 可以像Snackbar一样attach到viewgroup里面或者像Toast一样的overlay，支持Top/Bottom两种模式 



### RecyclerView
- [Learning-RecyclerView](https://github.com/CameloeAnthony/Learning-RecyclerView) RecyclerView大集合
- [ListViewAnimations](https://github.com/nhaarman/ListViewAnimations)
- [recyclerview-animators](https://github.com/wasabeef/recyclerview-animators)
- [android-drag-square](https://github.com/xmuSistone/android-drag-square)   可拖拽的gridView
- [AdvancedRecyclerView](https://github.com/StephenVinouze/AdvancedRecyclerView) 支持单选多选
...
- [SwipeLayout](https://github.com/fanrunqi/SwipeLayout)
...
- [ExpandableRecyclerView](https://github.com/grennis/ExpandableRecyclerView)
- [PinnedAndPulledHeaderListView](https://github.com/younfor/PinnedAndPulledHeaderListView) 仿QQ好友列表分组悬停
...
- [CalendarSelector](https://github.com/TUBB/CalendarSelector)
- [Android-LunarView](https://github.com/Coolerfall/Android-LunarView)


### 联系人分组
- [StickyListHeaders](https://github.com/emilsjolander/StickyListHeaders)
- [SuperSLiM](https://github.com/TonicArtos/SuperSLiM)
- [IndexRecyclerView](https://github.com/jiang111/IndexRecyclerView)        通过RecyclerView实现的联系人
- [WaveSideBar](https://github.com/Solartisan/WaveSideBar)                  一个快速跳跃分组的侧边栏控件
- [WaveSideBar](https://github.com/gjiazhe/WaveSideBar)
- [Android-QuickSideBar](https://github.com/saiwu-bigkoo/Android-QuickSideBar)  帮助快速查阅对应分组的侧边栏
...
- [SpiderWebScoreView](https://github.com/xiaopansky/SpiderWebScoreView)    [NetView](https://github.com/a-voyager/NetView) 蜘网图(雷达图)控件
- [polygonsview](https://github.com/jiangzehui/polygonsview)                模仿掌上英雄联盟能力分析效果 
- [LeafChart](https://github.com/LineChen/LeafChart)                        小型图表库-折线统计图、直方统计图
- [RadarChart](https://github.com/qstumn/RadarChart) 支持自由定制外观、手势旋转的雷达图表
- [SesameCreditScore](https://github.com/alidili/SesameCreditScore) 
