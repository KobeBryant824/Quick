...
### AS快捷键
    ...
    Alt  + Shift + Up、Down 移动单行
    Alt	 + Up、Down         方法间快速切换
	Ctrl + Left、Right      单词之间跳转
...
-  tools:text="Item 1" 界面预览tools各种属性
-  Databinding Support
-  Insight.io  可能是迄今为止最好的 GitHub 代码浏览插件
-  toolbar默认最左边是有padding的，app:contentInsetStart="0dp" 去掉就可以紧贴左边了
...
### 动态改变高度
    ...
    private void performAnim2() {
        ...
        ValueAnimator va;
        if (show) {
            va = ValueAnimator.ofInt(0, mHeight);
        } else {
            va = ValueAnimator.ofInt(mHeight, 0);
        }
        va.addUpdateListener(valueAnimator -> {
            int h = (Integer) valueAnimator.getAnimatedValue();
            expandableLayoutSign.getLayoutParams().height = h;
            expandableLayoutSign.requestLayout();
        });
        va.setDuration(200);
        va.start();
    }
...
- Item 水波纹效果
	外层Item背景的水波纹效果android:background="?attr/selectableItemBackground"
    外层Item前景的水波纹效果android:foreground="?attr/selectableItemBackground"
    cardview的水波纹效果android:foreground="?attr/selectableItemBackground" 

- ImageView水波纹      android:background="?attr/selectableItemBackgroundBorderless"
...
#### author  类的详细 
    ...
    /**
     * Created by Hai (haigod7@gmail.com) on ${DATE} ${TIME}.
     */
	 
	 /**
	  * 作者:陈新海 邮件:haigod7@gmail.com
	  * 创建时间:${DATE} ${TIME}
	  * 描述:
	  */
